...
| 语义分割 | RSA-LOAM | ICRA 2021 | [[Article]](https://arxiv.org/abs/2106.11516) |
...
| 自动驾驶 | 模型车自动驾驶平台及车道线识别算法设计与实现 | Master Thesis 2021 | - |
...
| - | 图像目标识别、检测与分割 | MAE | 2021.11 | [[Article]](https://arxiv.org/abs/2111.06377)
